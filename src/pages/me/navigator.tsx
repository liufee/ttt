...
import financialYearScreen from './financial/FinancialYearScreen';
...
const FinancialStack = ()=> {
    return (
        <Stack.Navigator>
            <Stack.Screen options={{ headerShown:false}} name="financialHome" component={FinancialScreen}/>
            <Stack.Screen options={{ headerShown:false}} name="financialYearScreen" component={financialYearScreen}/>
        </Stack.Navigator>
    );
};
...
const MeNavigator = () => {
    ...
    return (
        <Tab.Navigator>
            <Tab.Screen name="financial" component={FinancialStack} options={{
                tabBarIcon: ({ color }) => (
                    <SvgXml
                        width="30"
                        height="30"
